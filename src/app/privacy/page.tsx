            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-slate-100">
                    ...
                    <div className="text-slate-600 space-y-6 text-lg leading-relaxed">
                        ...
                        <h3 className="text-xl font-bold text-slate-800 mt-8 mb-4">1. المعلومات التي نجمعها</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-slate-800 mt-8 mb-4">2. كيف نستخدم معلوماتك</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-slate-800 mt-8 mb-4">3. أمان البيانات</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-slate-800 mt-8 mb-4">4. التغييرات في سياسة الخصوصية</h3>
                        <p>
