            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-[#0a0a0a] rounded-3xl p-8 md:p-12 shadow-xl border border-white/10">
                    ...
                    <div className="text-zinc-400 space-y-6 text-lg leading-relaxed">
                        ...
                        <h3 className="text-xl font-bold text-white mt-8 mb-4">1. قبول الشروط</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-white mt-8 mb-4">2. الأسعار وتوفر المنتجات</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-white mt-8 mb-4">3. حقوق الملكية الفكرية</h3>
                        <p>
                        ...
                        <h3 className="text-xl font-bold text-white mt-8 mb-4">4. إخلاء المسؤولية</h3>
                        <p>
