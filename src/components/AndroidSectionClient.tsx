        ...
        <section id="android" className="py-20 relative z-10 bg-slate-50 border-t border-slate-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    ...
                    <button className="flex items-center justify-center gap-2 bg-white text-slate-700 font-bold px-6 py-3 rounded-xl border border-slate-200 hover:border-emerald-500 hover:text-emerald-600 transition-all shadow-sm">
                        عرض كل الأجهزة <ChevronRight className="w-5 h-5" />
                    </button>
                </div>
                            ...
                            <div className="flex-1 flex flex-col">
                                ...
                                <div className="pt-4 border-t border-slate-100 mt-auto space-y-4">
                                    <div className="flex items-end justify-between">
                                        <div className="text-2xl font-black text-brand-dark">${product.price_usd}</div>
                                        <div className="text-sm font-bold text-slate-500">
                                            {product.price_iqd.toLocaleString('ar-IQ')} <span className="text-[10px]">د.ع</span>
                                        </div>
                                    </div>
                                    <button
