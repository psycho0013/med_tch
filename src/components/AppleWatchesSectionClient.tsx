        ...
        <section id="apple-watches" className="py-20 relative z-10 bg-white border-t border-slate-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    ...
                    <Link href="/category/apple-watches" className="relative overflow-hidden flex items-center justify-center gap-2 bg-white text-red-700 font-bold px-6 py-3 rounded-xl border border-red-200 transition-all shadow-sm group">
