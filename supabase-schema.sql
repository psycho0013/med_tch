...
CREATE TABLE IF NOT EXISTS products (
  ...
  category TEXT NOT NULL CHECK (category IN ('pcs', 'monitors', 'accessories')),
  name TEXT NOT NULL,
  brand TEXT NOT NULL,
...
VALUES (1, 'بوابة المستقبل.. اختر قطع البي سي بذكاء', 'نقارن لك أفضل تجميعات الـ PC، الشاشات، وإكسسوارات القيمنق المتاحة في العراق. اكتشف الأسعار الحقيقية، الميزات، واختر الأنسب لميزانيتك واحتياجاتك بخطوات بسيطة.', 'استكشف التجميعات', 'أفضل تجميعات', 'تجميعات RTX 5000 & شاشات OLED وصلوا !!', true)
ON CONFLICT (id) DO NOTHING;

-- Insert default site settings
INSERT INTO site_settings (id, site_name, description, exchange_rate)
VALUES (1, 'تك كومبير PC', 'المنصة رقم 1 في العراق لمقارنة تجميعات الـ PC والشاشات وملحقات الألعاب لعام 2026.', 1500)
ON CONFLICT (id) DO NOTHING;
